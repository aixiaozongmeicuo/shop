...
@section('content')
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="active"><a href="javascript:;">添加属性</a></li>
    </ul>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="/admin/huopin/store" method="post" class="form-horizontal" role="form">
                {{csrf_field()}}
                @foreach($attrs as $v)
                    ...
                    <div class="col-sm-10" >
                        <select name="zuhe[]" id="inputATTR" class="form-control">
                            ...
                            @foreach($v['sonAttrs'] as $vv)
                                <option value="{{$vv['id']}}">{{$vv['aname']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="kucun" class="form-control" value="">
