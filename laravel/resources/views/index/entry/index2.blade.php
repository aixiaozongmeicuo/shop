            ...
            <div class="global_food"
                ...
                <div class="left_banner">
                    ...
                    <div class="banner_link">
                        <ul class="clearfix">
                            <li>
                                <a title="进口饼干" target="_blank" href="">进口饼干</a>
                            </li>
        ...
        <div class="fl mod_columns_floor live_fresh" id="floorHSSX">
            <div class="floor_tit clearfix">
                ...
                <div class="keywords">
                    <ul class="clearfix">
                        <li>
                            <a title="冷冻速食" target="_blank" href="">冷冻速食</a>|
                        </li>
                    </ul>
                </div>
            </div>
...
<textarea style="display:none;" autocomplete="off" id="textareaFloorGHMZ">
        ...
        <div class="left_con">
            <h4><a title="{{$mzmodel['description']}}" href="" target="_blank">{{$mzmodel['cname']}} <i>&gt;</i></a></h4>
                <p class="en_tit">{{$mzmodel['description']}}</p>
    <div class="floor_silder">
        <ul>
            @foreach($threechildmz as $v)
        ...
        <div class="center_con">
            <div class="keywords">
                <ul class="clearfix">
                    @foreach($ThreemzCategory as $v)
                        <li>
                        |<a target="_blank" href="">{{$v['cname']}}</a>
                    </li>
                    @endforeach
...
<textarea style="display:none;" autocomplete="off" id="textareaFloorSJJD">
        ...
        <div class="center_con">
            <div class="keywords">
                <ul class="clearfix">
                   @foreach($ThreephoneCategory as $v)
                        <li>
                        |<a target="_blank" href="">{{$v['cname']}}</a>
                    </li>
                    @endforeach
