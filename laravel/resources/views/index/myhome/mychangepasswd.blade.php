...
<head>
    <meta charset="UTF-8">
    <title>myorder-changepasswd</title>
    <!--css start-->
    ...
    <link href="//img.yihaodianimg.com/myyhd/member/css/usercenter.css?0" rel="stylesheet" type="text/css"/>
            ...
            <div class="hd_header_right">
                <div class="clearfix">
                    ...
                    <div class="hd_mini_cart" id="miniCart" data-version="1">
                        ...
                        <a class="hd_prism_cart" href="/index/showcart" style="height: 40px">
    ...
    <div class="wrap clearfix">
        ...
        <div class="mpc_cont_main">
            {{--<ul class="safeCenterMody">--}}
                    <div class="mpc_cont_main" style="height: 200px">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">修改密码</h3>
                            </div>
                            <div class="panel-body" >
                                <form action="/index/mychangepasswdcheck" method="post" class="form-horizontal" role="form">
                                    {{csrf_field()}}
